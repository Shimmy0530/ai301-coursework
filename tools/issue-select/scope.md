...
I'm comfortable with Python and shell/PowerShell scripting, and have done
Android/Kotlin app work (Firebase integration, APK signing/release) and some
GCP Linux VM administration. I've done light security-tooling and browser
automation work. For this first issue I'd like something in Python or a
scripting language over an unfamiliar frontend stack, and I'd rather avoid
anything requiring deep familiarity with a large existing GUI/frontend
codebase I've never touched (e.g. a big JS/TS single-page app) as my very
first PR into an unfamiliar repo.
